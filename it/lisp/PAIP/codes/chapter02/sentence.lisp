...
(defun rewrites (category)
  "Return a list of the possible rewrites for thie category."
...
(defun generate-2 (phrase)
  "Exercise 2.1 Write a version of `generate' that uses `cond'
...
(defun generate-3 (phrase)
  "Exercise 2.2 Write a version of `generate' that explicity
   differentiates between terminal symbols (those with to rewrite rules)
   and nonterminal symbols."
  (cond ((listp phrase)
         (mappend #'generate-3 phrase))
